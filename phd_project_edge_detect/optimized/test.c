...
void verify_edge_detect(int* __restrict__ image_buffer1, int* __restrict__ image_buffer2, 
	int* __restrict__ image_buffer3, int start_indx, int end_indx)
{
  int filter[K*K];
...
void initialize(int* __restrict__ image_buffer1, int* __restrict__ image_buffer2, 
	int* __restrict__ image_buffer3, int start_indx, int end_indx)
{
  int i, j ;
...
int verify_result(struct buffer* buffers)
{
	...
	//
	//int *image_buffer1 = buffers[0].bo[0]->map ;
	//int *image_buffer2 = buffers[1].bo[0]->map ;
	//int *image_buffer3 = buffers[2].bo[0]->map ;

	//for(i=0 ; i<SIZE ; i++) {
	//	for(j=0 ; j<SIZE ; j++) {
	//		if(IB1[i*SIZE+j] != image_buffer1[i*SIZE+j]) {
	...
	//for(i=0 ; i<SIZE ; i++) {
	//	for(j=0 ; j<SIZE ; j++) {
	//		if(IB2[i*SIZE+j] != image_buffer2[i*SIZE+j]) {                         
	...
	//for(i=0 ; i<SIZE ; i++) {
	//	for(j=0 ; j<SIZE ; j++) {
	//		if(IB3[i*SIZE+j] != image_buffer3[i*SIZE+j]) {
