...
void convolve2d(int input_image[N][N], int kernel[K][K], int output_image[N][N], int start_indx, int end_indx);
void set_filter(int filter[K][K], int type) ;
void apply_threshold(int image_buffer1[N][N], int image_buffer2[N][N], int image_buffer3[N][N], int start_indx, int end_indx) ;
