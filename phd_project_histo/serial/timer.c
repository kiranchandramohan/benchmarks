...
void print_time(struct timer* tm)
{
...
void print_float_time_summary(struct timer* tm, struct timer* exp_runtime, struct timer* tm_a9, struct timer* tm_a9_0, 
	struct timer* tm_a9_1, struct timer* tm_m3, struct timer* tm_dsp)
{
        float total_time = get_float_time(tm) ;
	...
	float runtime = get_float_time(exp_runtime) ;

        printf("Time<total,runtime, a9-sync,a9,m3,dsp> = <%f,%f,%f,%f,%f,%f>\n", total_time, runtime, a9_sync_time, a9_time, m3_time, dsp_time) ;
}
