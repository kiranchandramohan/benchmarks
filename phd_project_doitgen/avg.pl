...
sub find_avg_time
{
	...
	my $size_dsp = $_[1] ;
	my $num_runs = $_[2] ;
	my $size_a9 = 64 - ($size_m3 + $size_dsp) ;
	my $total_time = 0 ;
	my $total_a9_time = 0 ;
	my $total_m3_time = 0 ;
	my $total_dsp_time = 0 ;
...
#for($indx1=32 ; $indx1>=0 ; $indx1--) {
#	my $block_size = 2 ;
#	my $a9_size = $indx1 * $block_size ;
#	find_avg_a9_time($a9_size, 3) ;
#}
